        ...
        <div className="container">
            ...
            {blogsData && blogsData.length > 0 && (
              (() => {
                  ...
                  return (
                      <a href={`/artikel/${featured.id}`} className="featured-article-card" data-category={attrs.category?.toLowerCase() || 'insight'}>
            ...
            <div className="blog-grid-new" id="articles-grid">
                {blogsData && blogsData.length > 1 && (
                    blogsData.slice(1).map((blog: any) => {
                        ...
                        return (
                            <div key={blog.id} className="blog-card-new vertical" data-category={attrs.category?.toLowerCase() || 'insight'} style={{cursor: 'pointer'}} onClick={() => window.location.href=`/artikel/${blog.id}`}>
