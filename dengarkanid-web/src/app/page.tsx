...
<section className="testimonials-section-new scroll-fade">
            <div className="testimonials-header text-center">
                ...
                <p className="text-muted">Don't just take our word for it—see what our customers have to say about their
                    experience!</p>
            </div>
            ...
            <div className="testimonials-marquee-wrapper">
                ...
                <div className="marquee-row marquee-left">
                    <div className="marquee-track">
                        {/*  Card 1  */}
                        <div className="testimonial-card color-red">
                            <p className="testi-quote">"I've tried countless tea brands, but nothing compares to the
                                freshness and aroma of this one. Every sip feels like a warm hug! My mornings are
                                incomplete without it."</p>
                            <div className="testi-user">
                                <img src="/assets/headshot-1.jpg" alt="Olivia Richardson" className="testi-avatar"/>
                                <div className="testi-meta">
                                    <h4>Olivia Richardson</h4>
                                    <span>New York, USA</span>
                                </div>
                            </div>
                        </div>
                        {/*  Card 2  */}
                        <div className="testimonial-card color-orange">
                            <p className="testi-quote">"As a tea lover, I appreciate the rich flavors and organic
                                ingredients. The chamomile blend has become my go-to for relaxation after a long day!"
                            </p>
                            <div className="testi-user">
                                <img src="/assets/headshot-2.jpg" alt="Sophia Mitchell" className="testi-avatar"/>
                                <div className="testi-meta">
                        ...
                        {/*  Card 3  */}
                        <div className="testimonial-card color-yellow">
                            <p className="testi-quote">"I never knew tea could taste this good! The flavors are so pure and
                                soothing. Plus, the packaging is beautiful - perfect for gifting too!"</p>
                            <div className="testi-user">
                                <img src="/assets/headshot-3.jpg" alt="Aisha Khan" className="testi-avatar"/>
                                <div className="testi-meta">
                                    <h4>Aisha Khan</h4>
                                    <span>London, UK</span>
                                </div>
                        ...
                        {/*  Duplicate Row 1 for seamless scrolling  */}
                        <div className="testimonial-card color-red">
                            <p className="testi-quote">"I've tried countless tea brands, but nothing compares to the
                                freshness and aroma of this one. Every sip feels like a warm hug! My mornings are
                                incomplete without it."</p>
                ...
                <div className="marquee-row marquee-right">
                    <div className="marquee-track">
                        {/*  Card 1  */}
                        <div className="testimonial-card color-green">
                            <p className="testi-quote">"I've tried countless tea brands, but nothing compares to the
                                freshness and aroma of this one. Every sip feels like a warm hug! My mornings are
                                incomplete without it."</p>
                            <div className="testi-user">
                        ...
                        {/*  Card 2  */}
                        <div className="testimonial-card color-blue">
                            <p className="testi-quote">"The variety of blends is amazing! Whether I need a morning energy
                                boost or a calming bedtime tea, this brand has it all. Highly recommend!"</p>
                            <div className="testi-user">
                                <img src="/assets/headshot-4.jpg" alt="Emily Sanders" className="testi-avatar"/>
                                <div className="testi-meta">
                                    <h4>Emily Sanders</h4>
                        ...
                        {/*  Card 3  */}
                        <div className="testimonial-card color-purple">
                            <p className="testi-quote">"This tea has changed my daily routine for the better! The detox
                                blend helps me feel refreshed and energized. Love the natural ingredients!"</p>
                            <div className="testi-user">
                                <img src="/assets/headshot-5.jpg" alt="Priya Deshmukh" className="testi-avatar"/>
                                <div className="testi-meta">
                        ...
                        {/*  Card 4  */}
                        <div className="testimonial-card color-pink">
                            <p className="testi-quote">"I'm obsessed with the matcha! It's so smooth and gives me the
                                perfect energy without any jitters. A must-try for all tea lovers!"</p>
                            <div className="testi-user">
                                <img src="/assets/headshot-2.jpg" alt="Mia Lawrence" className="testi-avatar"/>
                                <div className="testi-meta">
                                    <h4>Mia Lawrence</h4>
                        ...
                        {/*  Duplicate Row 2 for seamless scrolling  */}
                        <div className="testimonial-card color-green">
                            <p className="testi-quote">"I've tried countless tea brands, but nothing compares to the
                                freshness and aroma of this one. Every sip feels like a warm hug! My mornings are
                                incomplete without it."</p>
                ...
                <div className="container contact-grid-new">
                    ...
                    <div className="contact-right-form">
                        <form className="contact-form-card"
                            onSubmit={(e) => { e.preventDefault(); alert('Message successfully sent!'); }}>
                            ...
                            {showCompanyDetails && (
                                <>
                                    <div className="form-group" style={{ animation: 'fadeIn 0.3s ease-in-out' }}>
                                        ...
                                        <input type="text" id="contact-industry" placeholder="Enter Industry" required />
                                    </div>
                                    <div className="form-group" style={{ animation: 'fadeIn 0.3s ease-in-out' }}>
                                        <label htmlFor="contact-position">Position</label>
                                        <input type="text" id="contact-position" placeholder="Enter Position" required />
                                    </div>
                                </>
                            )}
                            ...
                            <button type="submit" className="btn-send-message">Send Message &nbsp;&rarr;</button>
                        </form>
                    </div>
                </div>
            </section>
