                ...
                <div className="blog-grid-new">
                    {blogsData && blogsData.length > 0 ? (
                        blogsData.slice(0, 5).map((blog: any, index: number) => {
                            ...
                            if (index === 0) {
                                return (
                                    <a href={`/artikel/${attrs.slug || blog.documentId}`} className="blog-card-new horizontal" key={blog.id} style={{textDecoration: 'none', color: 'inherit'}}>
                                ...
                                return (
                                    <a href={`/artikel/${attrs.slug || blog.documentId}`} className="blog-card-new vertical color-purple-banner" key={blog.id} style={{textDecoration: 'none', color: 'inherit'}}>
                                ...
                                return (
                                    <a href={`/artikel/${attrs.slug || blog.documentId}`} className="blog-card-new vertical" key={blog.id} style={{textDecoration: 'none', color: 'inherit'}}>
                                        <div className="card-img-top">
                                            <StrapiMedia imageObj={attrs.thumbnailImage} fallbackUrl="https://placehold.co/400x300/ffffff/dddddd?text=No+Image" alt={attrs.title} />
                                        </div>
                                        <div className="card-content-bottom">
